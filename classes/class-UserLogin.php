    ...
    public function check_userlogin(){
        ...
        if($this->phpass->CheckPassword($user_password, $fetch['user_password'])){
            ...
            if($post){
                ...
                $_SESSION['userdata']['user_permissions'] = unserialize($fetch['user_permission']);
                ...
                if(isset($_SESSION['goto_url'])){
                    ...
                    echo '<meta hrrp-equiv="Refresh" content="0; url='.$goto_url.'">';
                }
		...
		//header( 'location: ' . $goto_url );       
            ...
            $this->logged_in = false;
            $this->login_error = 'Senha não confere.';
